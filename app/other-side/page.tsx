...
export default function OtherSidePage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-between overflow-hidden">
      ...
      <WorldNavigation currentRealm="other-side" />
            ...
            <Card variant="crimson" className="space-y-4">
              <CardHeader>
                ...
                <CardDescription className="text-slate-400">
                  CORRUPTION RESISTANCE PENALTIES
                </CardDescription>
              </CardHeader>
              <CardContent className="pt-2">
                <AttributeBar corrupted />
              </CardContent>
            </Card>
          </motion.div>
              ...
              <CardContent className="space-y-5">
                ...
                <div className="p-4 bg-red-950/30 border border-red-900/50 rounded-xs space-y-2">
                  <div className="flex items-center gap-2 text-xs font-mono font-bold text-red-300">
                    ...
                    <span>BANISHMENT PROTOCOL (SLATED FOR PHASE 2)</span>
                  </div>
                  <p className="text-xs font-mono text-slate-300 leading-relaxed">
                    In the full RPG system, completing consecutive real-life Focus and Body missions damages the boss barrier. Defeating The Procrastinator purges 30% of world corruption and awards legendary badges.
                  </p>
                </div>
      ...
      <footer className="relative z-20 py-4 px-6 border-t border-red-950/60 bg-black/50 backdrop-blur-xs">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between text-xs font-mono text-slate-400 gap-2">
          <div>THE OTHER SIDE // CORRUPTED SECTOR 99</div>
